...
namespace SummerFresh.Business
{
    public static class TypeHelper
    {
        ...
        public static List<Assembly> Assemblies
        {
            get
            {
                if (_assemblies == null)
                {
                    ...
                    if (!SysConfig.Assemblies.IsNullOrEmpty())
                    {
                    ...
                    _assemblies.Add(Assembly.Load("SummerFresh.Controls"));
                    _assemblies.Add(Assembly.Load("SummerFresh.Business"));
                }
                return _assemblies;
            }
        }
        ...
        /// <returns></returns>
        public static List<T> GetAllSubTypeInstance<T>(List<Type> types = null) where T : class,new()
        {
