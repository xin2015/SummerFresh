...
namespace SummerFresh.Data.Mapping
{
    public class TypeMapper
    {
        ...
        public static T Read<T>(IDictionary<string,object> data, Type instanceType)
        {
            if (null != data)
            {
                FastType reflection = TypeReflection.Get(instanceType);
                ...
                foreach (String key in data.Keys)
                {
                    ...
                    if (null != prop)
                    {
                        prop.SetValue(instance,data[key].ConventToType(prop.Type));
                    }
                }
                return (T)instance;
            }
                                 ...
                                 PropertyMapping[] mappings)
        {
            ...
            foreach (PropertyMapping mapping in mappings)
            {
                ...
                prop.SetValue(instance, reader.GetValue(mapping.Index).ConventToType(prop.Type));
            }
            return (T)instance; 
        }
        ...
        private static PropertyMapping[] GetSetterMappings(Type type, IDataReader reader, string mappingKey = null)
        {
            ...
            */
            ...
            FastType reflection = TypeReflection.Get(type);
