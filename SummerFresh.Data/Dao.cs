...
namespace SummerFresh.Data
{
    ...
    public abstract class Dao
    {
        ...
        /// <para/>
        /// <para>此方法等同于<see cref="M:SummerFresh.Data.DaoFactory.GetDao">DaoFactory.GetDao()</see>.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <para> </para>
        /// <para>此方法等同于<see cref="M:SummerFresh.Data.DaoFactory.GetDao(System.String)">DaoFactory.GetDao(string name)</see></para>
        /// </summary>
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public abstract int BatchInsert<T>(IList<T> data, string tableName = null);
        ...
        public abstract T Select<T>(object id) where T : class, new();
        ...
        /// <param name="id">对于以一个字段作为关键字的表，传入单个字段的值；对于多个字段作为关键字的表，则需要以Dictionary或者Entity的方式传入</param>
        /// <returns></returns>
        public abstract object Select(Type type, object id);

        /// <summary>
        /// 查询表所有的数据，以集合方式返回
        /// </summary>
        /// <typeparam name="T">单条数据所对应的对象类型</typeparam>
        public abstract IList<T> SelectAll<T>() where T : class, new();

        /// <summary>
        /// 查询表所有的数据，以集合方式返回
        /// </summary>
        /// <typeparam name="T">单条数据所对应的对象类型</typeparam>
        public abstract IList<object> SelectAll(Type type);
